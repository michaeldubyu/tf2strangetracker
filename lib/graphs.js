...
$(window).load(function(){                
    ...
    function showSelectedStats(ranges,plot,data){
        ...
        $("#stat_list").append('<ul><li class=\'selected_stat\'>&#916;kills/hr in selection : <span id=\'stat_value\'>'+d.substr(0,6)+'</li></ul>');
    }
    ...
    if ($(".graph_daily").length){
        ...
        function hourStat(finalData){
            ...
            $("#stat_list").append('<ul><li>&#916;kills/hr in last 24hrs: <span id=\'stat_value\'> '+kph.substr(0,6)+'</li></ul><br id="not-select"\>');
        }
    ...
    if ($(".graph_weekly").length){
        ...
        function onOutboundReceivedWeekly(series) {
            ...
            function hourStat(finalData){
                ...
                kph = kill_delta / elapsed_hours;
                kph = new String(kph);
                $("#stat_list").append('<ul><li>&#916;kills/hr in this month: <span id=\'stat_value\'>'+kph.substr(0,6)+'</li></ul>');
                ...
                kpd = new String(kpd);
                $("#stat_list").append('<ul><li>&#916;kills/day in this month: <span id=\'stat_value\'>'+kpd.substr(0,6)+'</li></ul>');
            }
