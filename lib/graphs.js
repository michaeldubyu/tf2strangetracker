    ...
    if ($(".graph_weekly").length){
        ...
        function onOutboundReceivedWeekly(series) {
            ...
            function hourStat(finalData){
                ...
                kph = kill_delta / elapsed_hours;
                kph = new String(kph);
                $("#stat_list").append('<ul><li>&#916;kills/hr in this month: <span style=\'color:#ccc;\'>'+kph.substr(0,5)+'</li></ul>');
                ...
                kpd = new String(kpd);
                $("#stat_list").append('<ul><li>&#916;kills/day in this month: <span style=\'color:#ccc;\'>'+kpd.substr(0,5)+'</li></ul>');
            }
